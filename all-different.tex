...
\title{``All Different'' and Consistency}
...
\begin{frame}[fragile]{What Does A Constraint Solver Do?}
    \only<1> {
        If we work with a solver directly rather than using MiniZinc, we can propagate
        constraints and then stop, without searching:
...
\begin{frame}{Do Global Constraints Always Help?}
    \begin{itemize}
        ...
        \item It is impossible to get GAC from a polynomial-sized SAT encoding.
